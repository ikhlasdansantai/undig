...
export default function Documentation() {
  return (
    <section id="documentaions" className="relative py-20 px-4 bg-[#15151f] z-20 overflow-hidden">
      <figure className="absolute top-0 left-0 z-0" data-aos="fade-right" data-aos-duration="2000">
        <img src={docsFlowerTop} alt="flower IMG" className="block max-w-full" />
      </figure>
      <div className="docs__contents relative z-20">
        <h2 className="text-3xl text-center text-white font-semibold tracking-wider" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1000">
          Dokumentasi
        </h2>
      ...
      <figure className="absolute bottom-0 right-0 z-0" data-aos="fade-left" data-aos-duration="1600">
